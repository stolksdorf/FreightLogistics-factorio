...
utils.addToExistingTech(data, "rail-signals", "fuel_sensor")
...
data:extend({
	...
	--Item
	{
		type = "item",
		name = "fuel_sensor",
		icon = "__freight-sensor__/fuelSensor/img/icon.png",
	...
	--Entity
	{
		...
		sprite =
		{
			filename = "__freight-sensor__/fuelSensor/img/entity.png",
			x = 61,
			width = 61,
			height = 50,
	...
	},
	{
		type = "virtual-signal",
		name = "signal_fueled",
		icon = "__freight-sensor__/fuelSensor/img/fuel_signal_green.png",
	...
	},
	{
		...
		icon = "__freight-sensor__/fuelSensor/img/fuel_signal_red.png",
		subgroup = "virtual-signal-info",
		order = "z[info-a]",
	},
})
